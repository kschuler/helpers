...
This shows four data tables in my participants.db. Each data table corresponds to the data for particular experiment. You can access a specific table using the [SQL engine](http://rmarkdown.rstudio.com/authoring_knitr_engines.html#sql): `{sql connection=mturk.data, output.var="mturk"}`. 
